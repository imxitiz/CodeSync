...
const SelectTrigger = forwardRef<HTMLButtonElement, SelectRadixTriggerProps>(
...
const SelectContent = forwardRef<HTMLDivElement, SelectRadixContentProps>(
...
const SelectViewport = forwardRef<HTMLDivElement, SelectRadixViewportProps>(
  ({ className, ...props }, ref) => (
    <SelectRadixViewport
...
const SelectItem = forwardRef<HTMLDivElement, SelectRadixItemProps>(
  ({ className, children, ...props }, ref) => (
    <SelectRadixItem
      className={cn(
